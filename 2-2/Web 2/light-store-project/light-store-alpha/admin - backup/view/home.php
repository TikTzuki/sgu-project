                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                ...
                                <input type="date" id="start-date-analysis" name="start-date-analysis"
                                    value="2020-05-05" max="2020-06-01">
                                <span> đến ngày: </span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="bg-dark p-10 text-white text-center">
                                            ...
                                            <h5 class="m-b-0 m-t-5" id="total-revenue">
                                                <!-- JS here-->
                                            </h5>
                                    ...
                                    <div class="col-6 m-t-15">
                                        <div class="bg-dark p-10 text-white text-center">
                                            ...
                                            <h5 class="m-b-0 m-t-5" id="avg-order-value">
                                                <!-- JS here-->
                                            </h5>
                        ...
                        <div class="d-flex flex-row comment-row m-t-0">
                            ...
                            <div class="comment-text active w-100">
                                ...
                                <div class="comment-footer">
                                    <span class="text-muted float-right"> Doanh thu từ sản phẩm<span class="subtotal-price"> 150000</span> </span>
                                    <span class="text-muted float-right"> Bán được <span class="quantity-selled"> 150000</span></span>
                                    <span class="text-muted float-right"> Giá: <span class="light-price"> 150000</span></span>
                                ...
                                <li class="list-group-item todo-item" data-role="task">
                                    ...
                                    <ul class="list-style-none assignedto">
                                        <li class="assignee"><img class="rounded-circle" width="40"
                                                src="library/assets/images/users/1.jpg" alt="user" data-toggle="tooltip"
                                                data-placement="top" title="" data-original-title="Steave"></li>
                                        <li class="assignee"><img class="rounded-circle" width="40"
                                                src="library/assets/images/users/2.jpg" alt="user" data-toggle="tooltip"
                                                data-placement="top" title="" data-original-title="Jessica"></li>
                                        <li class="assignee"><img class="rounded-circle" width="40"
                                                src="library/assets/images/users/3.jpg" alt="user" data-toggle="tooltip"
                                                data-placement="top" title="" data-original-title="Priyanka"></li>
                                        <li class="assignee"><img class="rounded-circle" width="40"
                                                src="library/assets/images/users/4.jpg" alt="user" data-toggle="tooltip"
            ...
            <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="chat-box scrollable" style="height:475px;">
                            ...
                            <ul class="chat-list">
                                <!--chat Row -->
                                <li class="chat-item">
                                    <div class="chat-img"><img src="library/assets/images/users/1.jpg" alt="user"></div>
                                ...
                                <!--chat Row -->
                                <li class="chat-item">
                                    <div class="chat-img"><img src="library/assets/images/users/2.jpg" alt="user"></div>
                                    <div class="chat-content">
                                ...
                                <!--chat Row -->
                                <li class="chat-item">
                                    <div class="chat-img"><img src="library/assets/images/users/3.jpg" alt="user"></div>
                                    <div class="chat-content">
                ...
                <div class="card">
                    ...
                    <div class="comment-widgets scrollable" style="max-height: 130px;">
                        <!-- Comment Row -->
                        <div class="d-flex flex-row comment-row m-t-0">
                            <div class="p-2"><img src="library/assets/images/users/1.jpg" alt="user" width="50"
                                    class="rounded-circle"></div>
                            <div class="comment-text w-100">
                                <h6 class="font-medium">James Anderson</h6>
                                <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="p-20">
                                <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out
                                    ...
                                    the comment..</p>
                                <img src="library/assets/images/background/img4.jpg" class="img-fluid">
                            </div>
                        </div>
                        <div class="tab-pane  p-20" id="profile" role="tabpanel">
                            <div class="p-20">
                                ...
                                <p class="m-t-10">And is full of waffle to It has multiple paragraphs and is full of
                                    ...
                                    come to an end.multiple paragraphs and is full of waffle to pad out
                                    the comment..</p>
                            </div>
                        </div>
