                    ...
                    <?php
                        while($row = $order_stmt->fetch()){
                            switch ($row["tinhtrang"]) {
                                case "0":
                                    $change_state = "<li><span><a href=\"./controller/manager_order_perform.php?order_id=".$row['mahd']."&new_state=1\"> Giao hàng </a></span></li>";
                                    break;
                                case "1":
                                    $change_state = "
                                    <li>
                                    <span><a href=\"./controller/manager_order_perform.php?order_id=".$row['mahd']."&new_state=2\"> Đã giao </a></span>
                                    </li>
                                    <li>
                                    <span><a href=\"./controller/manager_order_perform.php?order_id=".$row['mahd']."&new_state=-1\"> Giao hàng thất bại </a></span>
                                    </li>";
                                    break;
                                default:
                                    $change_state ="";
                            ...
                            "<tr>
                                ...
                                <ul>
                                    <li>
                                        <span><a href=\"?page=order_detail&order_id=".$row['mahd']."\"> Chi tiết </a></span>
                                    </li>
                                    ".$change_state."
                                </ul>
                                </td>
