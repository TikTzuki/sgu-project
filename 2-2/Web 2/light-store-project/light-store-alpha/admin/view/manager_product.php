        ...
        <div class="row">
            <div class="row">
                ...
                <form action="?page=manager_product" method="POST">
                    ...
                    <input name="light_min_price" type="text" placeholder="Thấp nhất" value="<?php if(isset($_POST['search']) && $_POST['light_min_price']!="")echo $_POST['light_min_price']; if(isset($_GET['page_num'])&& isset($_GET['light_min_price']))echo $_GET['light_min_price']; ?>">
                    <input name="light_max_price" type="text" placeholder="Cao nhất" value="<?php if(isset($_POST['search']) && $_POST['light_max_price']!="")echo $_POST['light_max_price']; if(isset($_GET['page_num'])&& isset($_GET['light_max_price']))echo $_GET['light_max_price']; ?>">
