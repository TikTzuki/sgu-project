                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        <>
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <IconButton aria-label="expand row"
                                                                onClick={(event) => handleExpand(event, row.order_id)}>
                                                        {expandedRow.includes(row.order_id) ? <KeyboardArrowUp/> :
                                                            <KeyboardArrowDown/>}
                                                    </IconButton>
                                                </TableCell>
                                            ...
                                            {/* Table expanded */}
                                            <ExpandRow style={{width: `100%`}} open={expandedRow.includes(row.order_id)}
