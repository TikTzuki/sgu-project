...
public class DeviceMainPanel1 extends JPanel {
    ...
    private void initData() {
        ...
        btn_xoa.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int value = JOptionPane.showConfirmDialog(table, "Bạn chắc chắn muốn xóa?");
                if (value == 0) {
                    deviceRepository.updateStatusDeleted((int) table.getValueAt(table.getSelectedRow(), 0));
                    loadtable();
                }
            }
        });
        ...
        btn_tim.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                model.setRowCount(0);
                List<Device> devices = deviceRepository.searchByName(txt_timKiem.getText());
...
//				panel.setBorder(new LineBorder(new Color(0, 0, 0)));
        ...
        lblNewLabel.setBounds(36, 29, 97, 23);
...
//				panel_1.setBorder(new LineBorder(new Color(0, 0, 0)));
        ...
        btn_sua.setForeground(Resources.C_DARK);
    ...
    private void loadtable() {
        model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);
        devices = deviceRepository.findAllNotDelete();
        devices.forEach(device -> {
            model.addRow(new Object[]{
                    device.getId(), device.getName(), deviceTypeRepository.findNameById(device.getDeviceTypeId()), device.getPrice(),
                    device.getQuantity(), brandRepository.findNameById(device.getBrandId())
    ...
    public static void main(String[] args) {
        new TestFrame(new DeviceMainPanel1());
